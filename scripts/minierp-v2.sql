...
(
  PreVenCabCod Int(10) NOT NULL,
  PreVenCabNum Char(20),
...
CREATE INDEX IX_Relationship137 ON en_p1m_usuario (UniTraCod)
;

CREATE INDEX IX_Relationship142 ON en_p1m_usuario (LisPreCod)
;
...
(
  FacComCabCod Int(10) NOT NULL,
  FacComCabNum Char(15),
  GuiRemRemNum Char(15),
  GuiRemTraNum Char(15),
...
ALTER TABLE en_p1m_empresa ADD PRIMARY KEY (EmpCod)
;
...
-- Table ta_gzz_unidad_trabajo

CREATE TABLE ta_gzz_unidad_trabajo
(
  UniTraCod Int(2) NOT NULL,
  UniTraDet Char(90),
  EstRegCod Char(1)
)
;

ALTER TABLE ta_gzz_unidad_trabajo ADD PRIMARY KEY (UniTraCod)
;

-- Table ta_gzz_lista_precios

CREATE TABLE ta_gzz_lista_precios
(
  LisPreCod Int(2) NOT NULL,
  LisPreDet Char(90),
  EstRegCod Char(1)
)
;

ALTER TABLE ta_gzz_lista_precios ADD PRIMARY KEY (LisPreCod)
;

-- Table en_p2m_precio_unitario

CREATE TABLE en_p2m_precio_unitario
(
  LisPreCod Int(2) NOT NULL,
  ClaProCod Char(2) NOT NULL,
  SubClaProCod Char(2) NOT NULL,
  ProCod Char(15) NOT NULL,
  PreUniVen Double(10,2) NOT NULL,
  PreUniCom Double(10,2),
  PreUniMar Double(10,2),
  PreUniFle Double(10,2)
)
;

ALTER TABLE en_p2m_precio_unitario ADD PRIMARY KEY (ProCod,SubClaProCod,ClaProCod,LisPreCod)
;

-- Table en_p1m_lista_precios_usuarios

CREATE TABLE en_p1m_lista_precios_usuarios
(
  LisPreCod Int(2) NOT NULL,
  UsuCod Char(15) NOT NULL,
  LisPreUsuDes Char(90),
  EstRegCod Char(1)
)
;

ALTER TABLE en_p1m_lista_precios_usuarios ADD PRIMARY KEY (UsuCod,LisPreCod)
;

-- Table en_p2m_combos

CREATE TABLE en_p2m_combos
(
  ComCod Char(15) NOT NULL,
  ComDet Char(90),
  ComTot Double(10,2),
  EstRegCod Char(1)
)
...
ALTER TABLE en_p2m_combos ADD PRIMARY KEY (ComCod)
;

-- Table en_p2m_combo_det

CREATE TABLE en_p2m_combo_det
(
  ComCod Char(15) NOT NULL,
  ClaProCod Char(2) NOT NULL,
  SubClaProCod Char(2) NOT NULL,
  ProCod Char(15) NOT NULL,
  ComDetCan Double(10,2)
)
;

ALTER TABLE en_p2m_combo_det ADD PRIMARY KEY (ComCod,ProCod,SubClaProCod,ClaProCod)
;
...
ALTER TABLE en_p1m_usuario ADD CONSTRAINT Relationship137 FOREIGN KEY (UniTraCod) REFERENCES ta_gzz_unidad_trabajo (UniTraCod) ON DELETE NO ACTION ON UPDATE NO ACTION
;

ALTER TABLE en_p2m_precio_unitario ADD CONSTRAINT Relationship138 FOREIGN KEY (ProCod, SubClaProCod, ClaProCod) REFERENCES en_p2m_producto (ProCod, SubClaProCod, ClaProCod) ON DELETE NO ACTION ON UPDATE NO ACTION
;

ALTER TABLE en_p2m_precio_unitario ADD CONSTRAINT Relationship139 FOREIGN KEY (LisPreCod) REFERENCES ta_gzz_lista_precios (LisPreCod) ON DELETE NO ACTION ON UPDATE NO ACTION
;

ALTER TABLE en_p1m_lista_precios_usuarios ADD CONSTRAINT Relationship140 FOREIGN KEY (UsuCod) REFERENCES en_p1m_usuario (UsuCod) ON DELETE NO ACTION ON UPDATE NO ACTION
;

ALTER TABLE en_p1m_lista_precios_usuarios ADD CONSTRAINT Relationship141 FOREIGN KEY (LisPreCod) REFERENCES ta_gzz_lista_precios (LisPreCod) ON DELETE NO ACTION ON UPDATE NO ACTION
;

ALTER TABLE en_p1m_usuario ADD CONSTRAINT Relationship142 FOREIGN KEY (LisPreCod) REFERENCES ta_gzz_lista_precios (LisPreCod) ON DELETE NO ACTION ON UPDATE NO ACTION
;

ALTER TABLE en_p2m_combo_det ADD CONSTRAINT Relationship143 FOREIGN KEY (ComCod) REFERENCES en_p2m_combos (ComCod) ON DELETE NO ACTION ON UPDATE NO ACTION
;

ALTER TABLE en_p2m_combo_det ADD CONSTRAINT Relationship144 FOREIGN KEY (ProCod, SubClaProCod, ClaProCod) REFERENCES en_p2m_producto (ProCod, SubClaProCod, ClaProCod) ON DELETE NO ACTION ON UPDATE NO ACTION
;
