...
ALTER TABLE en_p3m_plantilla_cab ADD PRIMARY KEY (PlaCod)
;
...
(
  PlaCod Char(10) NOT NULL,
  PlaDetCod Int(3) ZEROFILL NOT NULL AUTO_INCREMENT,
...
(
  CueBanCod Int(10) ZEROFILL NOT NULL,
...
ALTER TABLE en_p3m_cuenta_banco ADD PRIMARY KEY (CueBanCod)
;
...
(
  LibDiaCod Char(10) NOT NULL,
  LibDiaPer Char(20) NOT NULL,
  EstRegCod Char(1) NOT NULL
)
;

ALTER TABLE en_p3m_libro_diario ADD PRIMARY KEY (LibDiaCod)
;
...
(
  LibDiaCod Char(10) NOT NULL,
  AsiCabCod Int(6) ZEROFILL NOT NULL,
...
ALTER TABLE en_p3m_asiento_cab ADD PRIMARY KEY (AsiCabCod,LibDiaCod)
;
...
(
  LibDiaCod Char(10) NOT NULL,
  AsiCabCod Int(6) ZEROFILL NOT NULL,
  AsiDetCod Int(4) ZEROFILL NOT NULL AUTO_INCREMENT,
  CueCod Int(10) ZEROFILL NOT NULL,
