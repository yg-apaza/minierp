...
<t:template-page-nav>
    <jsp:attribute name="mybody">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group input-group" >
                                ...
                                <input class="form-control" type="text" name="proDes" id="proDesShow" placeholder="Descripción" readOnly>
                            ...
                            <div class="form-group input-group" >
                                ...
                                <input class="form-control" type="text" name="proCod" id="proCodShow" placeholder="Código" readOnly>
        ...
        <div id="pSuccess" class="modal fade">
            <div class="modal-dialog modal-md">
                <div class="modal-content" style="overflow-y: auto">
                    <div class="modal-body">
                        <p class="text-center text-success">La preventa ha sido agregada correctamente</p>
                    </div>
                </div>         
            </div>
        </div>
                    ...
                    rules: {
                        preVenCabCod: {
                            ...
                            remote: {
                                ...
                                data: {preVenCabCod: function () {
                                        return $("#codePreVenCabCod").val();
                                    }}
                            }
                        },
                        cliCod: {
