    ...
    <jsp:attribute name="contenido">
        <div class="panel-body">
            ...
            <div class="col-md-4">
                ...
                <a href="${pageContext.request.contextPath}/secured/reporte?type=pdf&&report=plancontable&&jdbc=false&&key=null&&value=null" class="btn btn-outline btn-danger btn-lg btn-block">
                    <i class="fa fa-file-pdf-o"></i>
                    Descargar Plan Contable [PDF]
                </a>
                <br>
                <a href="${pageContext.request.contextPath}/secured/reporte?type=xls&&report=plancontable&&jdbc=false&&key=null&&value=null" class="btn btn-outline btn-success btn-lg btn-block">
