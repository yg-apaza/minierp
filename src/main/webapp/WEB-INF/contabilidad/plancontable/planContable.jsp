    ...
    <jsp:attribute name="contenido">
        <div class="panel-body">
            ...
            <div class="col-md-4">
                ...
                <a href="${pageContext.request.contextPath}/secured/general/reporte?type=pdf&&report=plancontable" class="btn btn-outline btn-danger btn-lg btn-block">
                    <i class="fa fa-file-pdf-o"></i>
                    Descargar Plan Contable [PDF]
                </a>
                <br>
                <a href="${pageContext.request.contextPath}/secured/general/reporte?type=xls&&report=plancontable" class="btn btn-outline btn-success btn-lg btn-block">
                    <i class="fa fa-file-excel-o"></i>
                    Descargar Plan Contable [XLS]
                </a>
                <br>
                <a href="${pageContext.request.contextPath}/secured/general/reporte?type=doc&&report=plancontable" class="btn btn-outline btn-primary btn-lg btn-block">
