            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="${pageContext.request.contextPath}/">
                        <img id="logoEmp" src="${pageContext.request.contextPath}/img/${empImg}">
                    </a>
                </div>
                    ...
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <cc:if test = "${sessionScope.usuario.getTaGzzTipoUsuario().getTipUsuCod()==2}">
                                <li>
                                    <a href="#"><i class="fa fa-cart-arrow-down fa-fw"></i> Seccion Ventas<span class="fa arrow"></span></a>
                                    <ul class="nav nav-second-level">
                                        <li>
                                            <a href="${pageContext.request.contextPath}/secured/ventas/factura">Ventas</a>
                                        </li>
                                        <li>
                                            <a href="${pageContext.request.contextPath}/secured/ventas/preventa">Preventa</a>
                                        </li>
