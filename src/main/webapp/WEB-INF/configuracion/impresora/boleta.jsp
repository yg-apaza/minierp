    ...
    <jsp:attribute name="contenido">
        ...
        <div class="pagel-body">
            ...
            <form id="updateBoleta" method="post" action="${pageContext.request.contextPath}/secured/configuracion/impresora/boleta">               
                <div class="col-md-9">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover table-condensed" id="tablaBolMar">
                            ...
                            <tr>
                                <td><input type="text" name="name" value="${bol.getName()}"></td>
                                ...
                                <td><input min="0" step="0.1" type="number" name="botMargin" value="${bol.getBotMargin()}">cm</td>                            
                            </tr>
                        </table>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover table-condensed" id="tablaMaxPro">
                            ...
                            <tr>
                                <td style="text-align: center"><input min="0" step="1" type="number" name="maxProducts" value="${bol.getMaxProducts()}"></td>
                            </tr>
                        </table>
                    </div>
                </div>            
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover table-condensed" id="tablaTopBolTot">
                            <tr>
                                <th style="text-align: center">SEPARACIÓN</th>
                            </tr>
                            <tr>
                                <td style="text-align: center"><input min="0" step="0.1" type="number" name="topBolTot" value="${bol.getTopBolTot()}">cm</td>
                            </tr>
                        </table>
                    </div>
                </div>            
