                                    ...
                                    <div class="form-group input-group" >
                                        ...
                                        <select class="form-control">
                                            <c:forEach items="${proveedores}" var="proveedor">
                                              <option value="${proveedor}">${proveedor.proDet}</option>
                                            </c:forEach>
                                        </select>                                    
                                    </div>
                                </div>
                                                ...
                                                <div class="form-group input-group" >
                                                    ...
                                                    <select class="form-control">
                                                        <c:forEach items="${metodosPagoFactura}" var="metodoPagoFactura">
                                                          <option value="${metodoPagoFactura}">${metodoPagoFactura.metPagDet}</option>
                                                        </c:forEach>
                                                    </select> 
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select class="form-control">
                                                        <c:forEach items="${tiposPagoFactura}" var="tipoPagofactura">
                                                          <option value="${tipoPagofactura}">${tipoPagofactura.tipPagDet}</option>
                                                        </c:forEach>
                                                    </select> 
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select class="form-control">
                                                        <c:forEach items="${monedas}" var="moneda">
                                                          <option value="${moneda}">${moneda.monDet}</option>
                                                        </c:forEach>
                                                    </select> 
                                                    <span class="input-group-addon"><i class="fa fa-money"></i></span>
                                                    </div>
