 ...
 */
@Entity
@Table(name="en_p4m_documento_proveedor"
    ,catalog="episerp"
)
public class EnP4mDocumentoProveedor  implements java.io.Serializable {
    ...
    @AttributeOverrides( {
        @AttributeOverride(name="prvCod", column=@Column(name="PrvCod", nullable=false, length=15) ), 
...
@ManyToOne(fetch=FetchType.LAZY)
    @JoinColumn(name="PrvCod", nullable=false, insertable=false, updatable=false)
