...
public class EnP1tPreventaDet  implements java.io.Serializable {
     ...
     private BigDecimal preVenDetCan;
     private BigDecimal preVenDetValUni;

    public EnP1tPreventaDet() {
    }

    public EnP1tPreventaDet(EnP1tPreventaDetId id, EnP1mPreventaCab enP1mPreventaCab, EnP2mProducto enP2mProducto, BigDecimal preVenDetCan, BigDecimal preVenDetValUni) {
       this.id = id;
    ...
    public BigDecimal getPreVenDetCan() {
        return this.preVenDetCan;
    }
    
    public void setPreVenDetCan(BigDecimal preVenDetCan) {
        this.preVenDetCan = preVenDetCan;
    }
    public BigDecimal getPreVenDetValUni() {
        return this.preVenDetValUni;
    }
    
    public void setPreVenDetValUni(BigDecimal preVenDetValUni) {
        this.preVenDetValUni = preVenDetValUni;
    }
