...
@Embeddable
public class AsientoDetId  implements java.io.Serializable {
    ...
    public AsientoDetId(int asiDetCod, int asiCabCod, String libDiaCod) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof AsientoDetId) ) return false;
		 AsientoDetId castOther = ( AsientoDetId ) other; 
